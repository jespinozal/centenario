    ...
    action1.setCallback(this, function (response) {
      ...
      if (state === "SUCCESS") {
        ...
        if (oRes) {
          ...
          component.set("v.noTieneContrato", oRes.noTieneContrato);
          component.set("v.esSolicitudOnBaseArras", oRes.esSolicitudOnBaseArras);
        ...
        if (oRes.estado == "OK") {
          ...
          toastEvent.setParams({
            ...
            messageTemplateData: [
              ...
              oRes.oportunidad.CEN_Nro_solicitud_presolicitud_arras__c,
